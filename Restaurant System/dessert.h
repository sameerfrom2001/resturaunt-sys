...
namespace RestaurantSystem {
	...
	/// Summary for dessert
	/// </summary>
	public ref class dessert : public System::Windows::Forms::Form
	{
	public:
		dessert(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(dessert::typeid));
			...
			this->combo5->Location = System::Drawing::Point(468, 389);
			...
			this->combo4->Location = System::Drawing::Point(468, 321);
			...
			this->combo3->Location = System::Drawing::Point(468, 243);
			...
			this->combo2->Location = System::Drawing::Point(468, 177);
			...
			this->label7->Location = System::Drawing::Point(766, 385);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(73, 31);
			this->label7->TabIndex = 65;
			this->label7->Text = L"70Rs";
			// 
			// label6
			// 
			...
			this->label6->Location = System::Drawing::Point(766, 314);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(88, 31);
			this->label6->TabIndex = 64;
			this->label6->Text = L"120Rs";
			// 
			// label5
			// 
			...
			this->label5->Location = System::Drawing::Point(766, 243);
			...
			this->label4->Location = System::Drawing::Point(766, 177);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(88, 31);
			this->label4->TabIndex = 62;
			this->label4->Text = L"500Rs";
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(766, 110);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(88, 31);
			this->label3->TabIndex = 61;
			this->label3->Text = L"300Rs";
			// 
			// combo1
			// 
			...
			this->combo1->Location = System::Drawing::Point(468, 110);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei UI", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(419, 470);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(184, 50);
			this->button1->TabIndex = 59;
			this->button1->Text = L"Back To Menu";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &dessert::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(428, 19);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(166, 50);
			this->label1->TabIndex = 58;
			this->label1->Text = L"Dessert";
			// 
			// checkBox5
			// 
			...
			this->checkBox5->Location = System::Drawing::Point(86, 380);
			this->checkBox5->Name = L"checkBox5";
			this->checkBox5->Size = System::Drawing::Size(127, 41);
			this->checkBox5->TabIndex = 57;
			this->checkBox5->Text = L"Pastry";
			...
			this->checkBox4->Location = System::Drawing::Point(86, 309);
			this->checkBox4->Name = L"checkBox4";
			this->checkBox4->Size = System::Drawing::Size(177, 41);
			this->checkBox4->TabIndex = 56;
			this->checkBox4->Text = L"Ice Cream";
			...
			this->checkBox3->Location = System::Drawing::Point(86, 238);
			this->checkBox3->Name = L"checkBox3";
			this->checkBox3->Size = System::Drawing::Size(126, 41);
			this->checkBox3->TabIndex = 55;
			this->checkBox3->Text = L"Halwa";
			...
			this->checkBox2->Location = System::Drawing::Point(86, 172);
			this->checkBox2->Name = L"checkBox2";
			this->checkBox2->Size = System::Drawing::Size(304, 41);
			this->checkBox2->TabIndex = 54;
			this->checkBox2->Text = L"Lemon Cheesecake";
			...
			this->checkBox1->Location = System::Drawing::Point(86, 105);
			this->checkBox1->Name = L"checkBox1";
			this->checkBox1->Size = System::Drawing::Size(178, 41);
			this->checkBox1->TabIndex = 53;
			this->checkBox1->Text = L"Lava Cake";
			...
			this->Name = L"dessert";
			this->Text = L"dessert";
			this->Load += gcnew System::EventHandler(this, &dessert::dessert_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void dessert_Load(System::Object^ sender, System::EventArgs^ e) {
		combo1->Text = "1";
		combo2->Text = "1";
		combo3->Text = "1";
		combo4->Text = "1";
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (checkBox1->Checked) {
		tempFood1->setName("Lava Cake");
		tempFood1->setPrice((300.0f * tempQuant1));
		tempFood1->setQuantity(tempQuant1);
		cust.setOrder(tempFood1);
		ordercount++;
	}
	if (checkBox2->Checked) {
		tempFood2->setName("Lemon Cheesecake");
		tempFood2->setPrice((500.0f * tempQuant2));
		tempFood2->setQuantity(tempQuant2);
		cust.setOrder(tempFood2);
		ordercount++;
	}
	if (checkBox3->Checked) {
		tempFood3->setName("Halwa");
	...
	if (checkBox4->Checked) {
		tempFood4->setName("Ice Cream");
		tempFood4->setPrice((120.0f * tempQuant4));
		tempFood4->setQuantity(tempQuant4);
		cust.setOrder(tempFood4);
		ordercount++;
	}
	if (checkBox5->Checked) {
		tempFood5->setName("Pastry");
		tempFood5->setPrice((70.0f * tempQuant5));
