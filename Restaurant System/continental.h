...
namespace RestaurantSystem {
	...
	/// <summary>
	/// Summary for continental
	/// </summary>
	public ref class continental : public System::Windows::Forms::Form
	{
	public:
		continental(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(continental::typeid));
			...
			this->combo5->Location = System::Drawing::Point(459, 387);
			...
			this->combo4->Location = System::Drawing::Point(459, 321);
			...
			this->combo3->Location = System::Drawing::Point(459, 243);
			...
			this->combo2->Location = System::Drawing::Point(459, 177);
			...
			this->label7->Location = System::Drawing::Point(794, 385);
			...
			this->label6->Location = System::Drawing::Point(794, 314);
			...
			this->label5->Location = System::Drawing::Point(794, 243);
			...
			this->label4->Location = System::Drawing::Point(794, 177);
			...
			this->label3->Location = System::Drawing::Point(794, 110);
			...
			this->combo1->Location = System::Drawing::Point(459, 110);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft YaHei UI", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(414, 465);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(184, 50);
			this->button1->TabIndex = 42;
			this->button1->Text = L"Back To Menu";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &continental::button1_Click);
			// 
			// label1
			// 
			...
			this->label1->Location = System::Drawing::Point(373, 19);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(246, 50);
			this->label1->TabIndex = 41;
			this->label1->Text = L"Continental";
			// 
			// checkBox5
			// 
			...
			this->checkBox5->Location = System::Drawing::Point(41, 375);
			this->checkBox5->Name = L"checkBox5";
			this->checkBox5->Size = System::Drawing::Size(186, 41);
			this->checkBox5->TabIndex = 40;
			this->checkBox5->Text = L"Corn Soup";
			...
			this->checkBox4->Location = System::Drawing::Point(41, 304);
			this->checkBox4->Name = L"checkBox4";
			this->checkBox4->Size = System::Drawing::Size(174, 41);
			this->checkBox4->TabIndex = 39;
			this->checkBox4->Text = L"Fried Fish";
			...
			this->checkBox3->Location = System::Drawing::Point(41, 238);
			this->checkBox3->Name = L"checkBox3";
			this->checkBox3->Size = System::Drawing::Size(205, 41);
			this->checkBox3->TabIndex = 38;
			this->checkBox3->Text = L"Roast Lamb";
			...
			this->checkBox2->Location = System::Drawing::Point(41, 165);
			this->checkBox2->Name = L"checkBox2";
			this->checkBox2->Size = System::Drawing::Size(276, 41);
			this->checkBox2->TabIndex = 37;
			this->checkBox2->Text = L"Sweet Potato Pie";
			...
			this->checkBox1->Location = System::Drawing::Point(41, 96);
			this->checkBox1->Name = L"checkBox1";
			this->checkBox1->Size = System::Drawing::Size(233, 41);
			this->checkBox1->TabIndex = 36;
			this->checkBox1->Text = L"Chicken Salad";
			...
			this->Name = L"continental";
			this->Text = L"continental";
			this->Load += gcnew System::EventHandler(this, &continental::continental_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void continental_Load(System::Object^ sender, System::EventArgs^ e) {
		combo1->Text = "1";
		combo2->Text = "1";
		combo3->Text = "1";
		combo4->Text = "1";
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (checkBox1->Checked) {
		tempFood1->setName("Chicken Salad");
	...
	if (checkBox2->Checked) {
		tempFood2->setName("Sweet Potato Pie");
		tempFood2->setPrice((300.0f * tempQuant2));
		tempFood2->setQuantity(tempQuant2);
		cust.setOrder(tempFood2);
		ordercount++;
	}
	if (checkBox3->Checked) {
		tempFood3->setName("Roast Lamb");
		tempFood3->setPrice((1000.0f * tempQuant3));
		tempFood3->setQuantity(tempQuant3);
		cust.setOrder(tempFood3);
		ordercount++;
	}
	if (checkBox4->Checked) {
		tempFood4->setName("Fried Fish");
	...
	if (checkBox5->Checked) {
		tempFood5->setName("Corn Soup");
		tempFood5->setPrice((150.0f * tempQuant5));
